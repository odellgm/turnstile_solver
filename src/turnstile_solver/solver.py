...
BROWSER_ARGS = {
  ...
  # Background Throttling (both included by default)
  # '--disable-backgrounding-occluded-windows',  # Keep hidden tabs active
  # '--disable-background-networking',  # Prevent background sync
